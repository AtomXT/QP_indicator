...
def main():
    ...
    df_parametric = pd.read_csv(results_dir + "/parametric_tree_path_Q.csv")
    df_all = pd.concat([df_all, df_parametric[df_parametric.formulation == 'tree']])
    ...
    plt.title('Log-Log Plot: CORe vs parametric (Path Graph)')
