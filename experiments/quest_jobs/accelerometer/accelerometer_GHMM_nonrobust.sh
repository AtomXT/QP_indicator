...
#SBATCH --time=00:10:00 ## how long does this need to run (remember different p>
#SBATCH --mem=12G ## how much RAM do you need per CPU, also see --mem=<XX>G for >
#SBATCH --job-name=acc_nonrobust  ## When you run squeue -u NETID this is how you ca>
#SBATCH --output=quest_jobs/outlog/acc_nonrobust_log ## standard out and standar>
...
python3 -m experiments.Run_accelerometer_GHMM \
  ...
  --inference_modes "nonrobust" \
  --timelimit "3600" \
  --threads "8" \
  --job_name "acc_nonrobust"
