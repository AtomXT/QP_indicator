...
#SBATCH --job-name=job6  ## When you run squeue -u NETID this is how you ca>
#SBATCH --output=quest_jobs/outlog/job6_log ## standard out and standar>
...
python3 -m experiments.Run_test_job6