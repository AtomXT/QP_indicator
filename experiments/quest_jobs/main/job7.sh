...
#SBATCH --job-name=job7  ## When you run squeue -u NETID this is how you ca>
#SBATCH --output=quest_jobs/outlog/job7_log ## standard out and standar>
...
python3 -m experiments.Run_test_job7