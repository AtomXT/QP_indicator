...
#SBATCH --job-name=diabetes  ## When you run squeue -u NETID this is how you ca>
#SBATCH --output=quest_jobs/outlog/diagonal_minus_low_rank1_log ## standard out and standar>
