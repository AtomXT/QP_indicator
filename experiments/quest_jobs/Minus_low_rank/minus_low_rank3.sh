...
#SBATCH --time=4:00:00 ## how long does this need to run (remember different p>
#SBATCH --mem=8G ## how much RAM do you need per CPU, also see --mem=<XX>G for >
#SBATCH --job-name=diabetes_m5  ## When you run squeue -u NETID this is how you ca>
#SBATCH --output=quest_jobs/outlog/diagonal_minus_low_rank3_log ## standard out and standar>
...
python3 -m experiments.Run_diagonal_minus_low_rank \
  --dataset "diabetes" \
  --timelimit "3600" \
  --dimension "5" \
  --job_name "diabetes_m5"
