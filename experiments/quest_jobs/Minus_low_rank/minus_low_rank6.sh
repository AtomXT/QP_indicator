...
#SBATCH --job-name=crime_m3  ## When you run squeue -u NETID this is how you ca>
#SBATCH --output=quest_jobs/outlog/diagonal_minus_low_rank6_log ## standard out and standar>
