...
#SBATCH --time=05:00:00 ## how long does this need to run (remember different p>
...
#SBATCH --output=quest_jobs/outlog/convex_job3_log ## standard out and standar>
...
python3 -m experiments.Run_convex_hull_job3
