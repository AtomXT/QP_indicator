...
#SBATCH --job-name=job4  ## When you run squeue -u NETID this is how you ca>
#SBATCH --output=quest_jobs/outlog/opt_job4_log ## standard out and standar>
...
python3 -m experiments.Run_opt_formulation_job4
