...
#SBATCH --job-name=r_bi_4  ## When you run squeue -u NETID this is how you ca>
#SBATCH --output=quest_jobs/outlog/robust_binary_classification_4_log ## standard out and standar>
