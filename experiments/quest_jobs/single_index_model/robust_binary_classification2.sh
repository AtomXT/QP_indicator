...
#SBATCH --time=3:00:00 ## how long does this need to run (remember different p>
#SBATCH --mem=8G ## how much RAM do you need per CPU, also see --mem=<XX>G for >
#SBATCH --job-name=r_bi_2  ## When you run squeue -u NETID this is how you ca>
#SBATCH --output=quest_jobs/outlog/robust_binary_classification_2_log ## standard out and standar>
...
python3 -m experiments.Run_single_index_model \
  --n_list "100" \
  --timelimit "3600" \
  --job_name "r_bi_2"
