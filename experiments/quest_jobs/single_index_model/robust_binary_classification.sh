...
#SBATCH --job-name=r_bi  ## When you run squeue -u NETID this is how you ca>
#SBATCH --output=quest_jobs/outlog/robust_binary_classification_1_log ## standard out and standar>
