...
#SBATCH --time=20:00:00 ## how long does this need to run (remember different p>
#SBATCH --mem=12G ## how much RAM do you need per CPU, also see --mem=<XX>G for >
#SBATCH --job-name=penalty_sparsity4  ## When you run squeue -u NETID this is how you ca>
#SBATCH --output=quest_jobs/outlog/Q_sparsity_penalty_sparsity4_log ## standard out and standar>
