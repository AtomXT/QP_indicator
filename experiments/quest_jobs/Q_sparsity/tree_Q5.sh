...
#SBATCH --job-name=tree_Q5  ## When you run squeue -u NETID this is how you ca>
#SBATCH --output=quest_jobs/outlog/Q_sparsity_tree_Q5_log ## standard out and standar>
...
python3 -m experiments.Run_tree_Q \
