...
#SBATCH --job-name=penalty_sparsity5  ## When you run squeue -u NETID this is how you ca>
#SBATCH --output=quest_jobs/outlog/Q_sparsity_penalty_sparsity5_log ## standard out and standar>
