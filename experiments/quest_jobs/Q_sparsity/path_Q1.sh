...
#SBATCH --job-name=path_Q1  ## When you run squeue -u NETID this is how you ca>
#SBATCH --output=quest_jobs/outlog/Q_sparsity_path_Q1_log ## standard out and standar>
...
python3 -m experiments.Run_path_Q \
