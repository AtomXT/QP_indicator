...
#SBATCH --job-name=penalty_sparsity2  ## When you run squeue -u NETID this is how you ca>
#SBATCH --output=quest_jobs/outlog/Q_sparsity_penalty_sparsity2_log ## standard out and standar>
