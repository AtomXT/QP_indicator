...
#SBATCH --job-name=path_Q_adv_exact5  ## When you run squeue -u NETID this is how you ca>
#SBATCH --output=quest_jobs/outlog/Q_sparsity_path_Q_adv_exact5_log ## standard out and standar>
...
python3 -m experiments.Run_path_Q_adversarial \
  ...
  --job_name "path_Q_adversarial_exact5"
