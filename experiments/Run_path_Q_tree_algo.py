...
def parse_args():
    ...
    p.add_argument("--n_list", type=str, default="10000",
        ...
        for rep in rep_list:
            ...
            for tau in tau_list:
                # try:
                    ...
                    result_opt = [n, tau, rep, 'tree', np.nan, np.nan, np.nan, tree_obj, np.nan, np.nan, np.count_nonzero(z_tree_vals), 0, tree_time]
