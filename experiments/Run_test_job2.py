    ...
    for m in m_list:
        for n in n_list:
            try:
                ...
                result_no_cut = [m, n, dataset, 'no_cut', root_bound[0], root_bound[1],
                ...
                result_cut = [m, n, dataset, 'cut', root_bound[0], root_bound[1],
                ...
                results_df.to_csv(f"{current_path}/../experiments_results/results_job2.csv")
            except:
                continue